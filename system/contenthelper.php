...
static function calculateKeyWordsWeight($keyWords)
    ...
    function getMajecticBacklinks($url)
    {
        ...
        //var_dump($cookie);
        $cookie = "RURI=account%2Flogin; _ga=GA1.2.1123763203.1459339548; _pk_id.2.c4b1=99ba1936f88898b3.1459339549.2.1460204509.1460203189.; visitor_id63022=179076790; _pk_ses.2.c4b1=*; STOK=naeL7yiM689kSIKAOM4f70u2qT; _gat=1"
